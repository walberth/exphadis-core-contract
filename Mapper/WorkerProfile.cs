...
public class WorkerProfile : Profile
{
    public WorkerProfile()
    {
        ...
        this.CreateMap<Domain.WorkerAggregates.Contract, ContractDto>()
            ...
            ?.ForMember(dest => dest.AfpType, opt => opt.MapFrom(src => $"{src.AfpType.TryParseEnum<AfpTypeEnum>()}"))
            ...
            ?.ForMember(dest => dest.IsFullYear, opt => opt.MapFrom(src => src.IsFullYear))
        ...
        this.CreateMap<ContractDto, Domain.WorkerAggregates.Contract>()
            ...
            ?.ForMember(dest => dest.AfpType, opt => opt.MapFrom(src => $"{src.AfpType.GetEnumMemberValue()}"))
